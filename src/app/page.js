...
export default function Home() {
  ...
  return (
    <div className="h-screen flex flex-col bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 overflow-hidden">
      {/* Header */}
      <header className="bg-white/90 backdrop-blur-lg border-b border-indigo-200/50 z-50 flex-shrink-0">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 max-w-7xl mx-auto h-full">
            ...
            <div className="space-y-6 overflow-y-auto">
              <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-indigo-200/30 p-8">
                ...
                <DataIngest sessionId={sessionId} />
              </div>
            </div>

            {/* Chat Panel */}
            <div className="space-y-6 flex flex-col min-h-0">
              <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-indigo-200/30 p-8 flex-1 flex flex-col min-h-0">
                <div className="flex items-center space-x-3 mb-6">
